...
def extract_video_urls(page_url):
    """
    Retorna titulo, ano e ate duas URLs de video (principal e alternativa).
    """
    resp = requests.get(page_url)
    resp.raise_for_status()
    soup = BeautifulSoup(resp.text, 'lxml')

    # Extrair titulo e ano
    ...
    # Coletar at̩ duas URLs de video
    video_urls = []
...
def main():
    try:
        ...
        print(f"Arquivo {MOVIES_FILE} ṇo encontrado.")
        sys.exit(1)
    ...
    for page in urls:
        ...
        try:
            ...
            if vids:
                ...
                print(f"  Aviso: nao encontrou videos em {page}")
